...
public class AgentManagerService
{
    ...
    public AgentManagerService(Kernel kernel, IChatHistoryHandler chatHistoryHandler,
        SettingsManagerService settingsManager,
        IRedisHandler redisHandler, IRedisMemoryProvider redisMemoryProvider, IST2130Queries agentPromptQueries, IOCRService ocrService)
    {
        _kernel = kernel;
