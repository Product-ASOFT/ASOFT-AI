...
{
    public sealed class DataLoaderService : IDataLoader
    {
        private readonly IRedisMemoryProvider _vectorDatabase;
        private readonly IOpenAIEmbeddingService _embeddingService;

        public DataLoaderService(IRedisMemoryProvider vectorDatabase, IOpenAIEmbeddingService openAIEmbeddingService)
        {
