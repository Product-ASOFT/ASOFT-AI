...
public abstract class ChatHistoryAgent : Agent
{
    ...
    /// <inheritdoc/>
    [Experimental("SKEXP0110")]
    protected override sealed IEnumerable<string> GetChannelKeys()
    {
    ...
    /// <inheritdoc/>
    [Experimental("SKEXP0110")]
    protected override sealed Task<AgentChannel> CreateChannelAsync(CancellationToken cancellationToken)
    {
