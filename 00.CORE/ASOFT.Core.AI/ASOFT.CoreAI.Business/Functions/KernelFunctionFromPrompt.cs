...
using ASOFT.CoreAI.Abstractions.ChatClient;
...
using ITextGenerationService = ASOFT.CoreAI.Abstractions.ITextGenerationService;
...
internal sealed class KernelFunctionFromPrompt : KernelFunction
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        //else if (result.AIService is Microsoft.Extensions.AI.IChatClient chatClient)
        //{
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    public static string CreateRandomFunctionName(string? prefix = "Function") => $"{prefix}_{Guid.NewGuid():N}";
