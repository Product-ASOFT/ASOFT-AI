...
public static class KernelExtensions
{
    ...
    #endregion CreateFunctionFromMethod
    ...
    #endregion CreateFunctionFromPrompt
    ...
    #endregion CreatePluginFromType
    ...
    /// See <see cref="KernelFunctionAttribute"/> attribute for details.
    /// </remarks>
    public static KernelPlugin CreatePluginFromObject<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.NonPublicMethods)] T>(this Kernel kernel, T target, JsonSerializerOptions jsonSerializerOptions, string? pluginName = null)
    {
        Verify.NotNull(kernel);
    ...
    #endregion CreatePluginFromObject
    ...
    public static KernelPlugin CreatePluginFromFunctions(this Kernel kernel, string pluginName, IEnumerable<KernelFunction>? functions) =>
        kernel.CreatePluginFromFunctions(pluginName, description: null, functions);
    ...
    #endregion CreatePluginFromFunctions
    ...
    {
        KernelPlugin plugin = kernel.CreatePluginFromType<T>(pluginName);
    ...
    public static IKernelBuilderPlugins AddFromType<T>(this IKernelBuilderPlugins plugins, string? pluginName = null)
    {
        ...
        plugins.Services.AddSingleton(serviceProvider => KernelPluginFactory.CreateFromType<T>(pluginName, serviceProvider));
        ...
        DynamicallyAccessedMemberTypes.NonPublicMethods)] T>(this IKernelBuilderPlugins plugins, JsonSerializerOptions jsonSerializerOptions, string? pluginName = null)
    {
        ...
        plugins.Services.AddSingleton(serviceProvider => KernelPluginFactory.CreateFromType<T>(jsonSerializerOptions, pluginName, serviceProvider));
    ...
    #endregion ImportPlugin/AddFromType
    ...
    {
        KernelPlugin plugin = kernel.CreatePluginFromObject(target, pluginName);
        kernel.Plugins.Add(plugin);
        return plugin;
    }
    ...
    /// See <see cref="KernelFunctionAttribute"/> attribute for details.
    /// </remarks>
    public static KernelPlugin ImportPluginFromObject<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.NonPublicMethods)] T>(this Kernel kernel, T target, JsonSerializerOptions jsonSerializerOptions, string? pluginName = null)
    {
        KernelPlugin plugin = kernel.CreatePluginFromObject(target, jsonSerializerOptions, pluginName);
        kernel.Plugins.Add(plugin);
        return plugin;
    }
    ...
    public static KernelPlugin AddFromObject<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.NonPublicMethods)] T>(this ICollection<KernelPlugin> plugins, T target, JsonSerializerOptions jsonSerializerOptions, string? pluginName = null, IServiceProvider? serviceProvider = null)
    {
        Verify.NotNull(plugins);
    ...
    /// </remarks>
    [Experimental("SKEXP0120")]
    public static IKernelBuilderPlugins AddFromObject<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.NonPublicMethods)] T>(this IKernelBuilderPlugins plugins, T target, JsonSerializerOptions jsonSerializerOptions, string? pluginName = null)
    {
        Verify.NotNull(plugins);
    ...
    #endregion ImportPlugin/AddFromObject
    ...
    public static KernelPlugin ImportPluginFromFunctions(this Kernel kernel, string pluginName, IEnumerable<KernelFunction>? functions) =>
        kernel.ImportPluginFromFunctions(pluginName, description: null, functions);
    ...
    {
        KernelPlugin plugin = kernel.CreatePluginFromFunctions(pluginName, description, functions);
        kernel.Plugins.Add(plugin);
        return plugin;
    }
    ...
    public static KernelPlugin AddFromFunctions(this ICollection<KernelPlugin> plugins, string pluginName, IEnumerable<KernelFunction>? functions) =>
        plugins.AddFromFunctions(pluginName, description: null, functions);
    ...
    #endregion ImportPlugin/AddFromFunctions
        ...
        JsonSerializerOptions? jsonSerializerOptions = null)
    {
        ...
        foreach (string functionDirectory in Directory.EnumerateDirectories(pluginDirectory))
        {
            ...
            if (File.Exists(configPath))
            {
                ...
                {
                    promptConfig = JsonSerializer.Deserialize<PromptTemplateConfig>(json, jsonSerializerOptions);
                }
                else
                {
                    promptConfig = PromptTemplateConfig.FromJson(File.ReadAllText(configPath));
                }
            }
            else
            {
    ...
    #endregion CreatePluginFromDirectory
    ...
    public static KernelPlugin ImportPluginFromPromptDirectory(
        ...
        IPromptTemplateFactory? promptTemplateFactory = null)
    {
        KernelPlugin plugin = kernel.CreatePluginFromPromptDirectory(pluginDirectory, pluginName, promptTemplateFactory);
        kernel.Plugins.Add(plugin);
        return plugin;
    }
    ...
    public static KernelPlugin ImportPluginFromPromptDirectory(
        ...
        IPromptTemplateFactory? promptTemplateFactory = null)
    {
        KernelPlugin plugin = kernel.CreatePluginFromPromptDirectory(pluginDirectory, jsonSerializerOptions, pluginName, promptTemplateFactory);
        kernel.Plugins.Add(plugin);
        return plugin;
    }
        ...
        IPromptTemplateFactory? promptTemplateFactory = null)
    {
        ...
        plugins.Services.AddSingleton(services =>
    ...
    #endregion ImportPlugin/AddFromPromptDirectory
    ...
    {
        return kernel.InvokePromptAsync<T>(
            promptTemplate,
            arguments,
            templateFormat,
            promptTemplateFactory,
    ...
    #endregion InvokePromptStreamingAsync
    ...
    #endregion Build for IKernelBuilder
}