...
public static class KernelHelpersUtils
{
    ...
    public static void RegisterHelperSafe(IHandlebars handlebarsInstance, string helperName, HandlebarsReturnHelper helper)
    {
    ...
    public static object? GetArgumentValue(object argument, KernelArguments kernelArguments)
    {
    ...
    public static Arguments ProcessArguments(Arguments arguments, KernelArguments kernelArguments)
    {
