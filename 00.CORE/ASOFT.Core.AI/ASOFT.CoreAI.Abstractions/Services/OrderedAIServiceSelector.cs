...
public sealed class OrderedAIServiceSelector : IAIServiceSelector, IChatClientSelector
{
        ...
        out PromptExecutionSettings? serviceSettings) where T : class
    {
        ...
        var executionSettings = arguments.ExecutionSettings != null ? arguments.ExecutionSettings : function.ExecutionSettings;
