...
namespace SharpPacker.Strategy.BoxPacker.Services
{
    internal class OrientatedItemFactory
    {
        ...
        protected int CalculateAdditionalItemsPackedWithThisOrientation(OrientatedItem prevItem,
                                                                        ItemList nextItems,
                                                                        float originalWidthLeft,
                                                                        float originalLengthLeft,
                                                                        float depthLeft,
                                                                        float currentRowLengthBeforePacking)
        {
        ...
        {
            var dimsA = new float[] { itemA.Width, itemA.Length, itemA.Depth };
            var dimsB = new float[] { itemB.Width, itemB.Length, itemB.Depth };
