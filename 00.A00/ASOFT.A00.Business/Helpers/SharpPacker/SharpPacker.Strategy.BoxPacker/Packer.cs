using SharpPacker.Strategy.BoxPacker;
using SharpPacker.Strategy.BoxPacker.Exceptions;
using SharpPacker.Strategy.BoxPacker.Models;
using SharpPacker.Strategy.BoxPacker.Services;
using System.Collections.Generic;
using System.Linq;

namespace SharpPacker.Strategy.BoxPacker
{
    public class Packer : IPacker
    {
        ...
        public virtual PackedBoxList Pack2()
        {
            var packedBoxes = DoVolumePacking();
            ...
            {
                var redistributor = new WeightRedistributor(_boxes);
                packedBoxes = redistributor.RedistributeWeight2(packedBoxes);
            }
